# Classification of the ImageWoof Dataset
...
My experiments can be replicated using `main.py` and my discussion of the experiments and their results can be found in the notebook `classification.ipynb`.
